...
void sendCommand(char command)
{
	...
	switch(command)
	{
		...
		case 'W':
			//getParams(&commandPacket);
			commandPacket.command = COMMAND_AUTO_FORWARD;
			sendPacket(&commandPacket);
			break;
		...
		case 'S':
			//getParams(&commandPacket);
			commandPacket.command = COMMAND_AUTO_REVERSE;
			sendPacket(&commandPacket);
			break;
		...
		case 'A':
			//getParams(&commandPacket);
			commandPacket.command = COMMAND_AUTO_LEFT;
			sendPacket(&commandPacket);
			break;
		...
		case 'D':
			//getParams(&commandPacket);
			commandPacket.command = COMMAND_AUTO_RIGHT;
			sendPacket(&commandPacket);
			break;
